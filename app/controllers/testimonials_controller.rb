class TestimonialsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @testimonial.save
        format.html { redirect_to @testimonial, notice: 'Отзыв успешно создан' }
  ...
  def update
    respond_to do |format|
      if @testimonial.update(testimonial_params)
        format.html { redirect_to @testimonial, notice: 'Отзыв успешно обновлен' }
  ...
  private
    ...
    def testimonial_params
      params.require(:testimonial).permit(:comment, :author, :company)
    end
end
