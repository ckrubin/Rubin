...
class TestimonialsControllerTest < ActionController::TestCase
  ...
  test "should create testimonial" do
    assert_difference('Testimonial.count') do
      post :create, testimonial: { author: @testimonial.author, comment: @testimonial.comment, company: @testimonial.company }
    end
  ...
  test "should update testimonial" do
    patch :update, id: @testimonial, testimonial: { author: @testimonial.author, comment: @testimonial.comment, company: @testimonial.company }
    assert_redirected_to testimonial_path(assigns(:testimonial))
  end
